...
export const Bunkei2022: Problem[] = [
  {
    ...
    category: "文系",
    content: {
      question: "\\[5.4 < \\log_4 2022 < 5.5\\]であることを示せ。 ただし、\\(0.301 < \\log_{10}2 < 0.3011\\) であることを用いてよい。",
      hints: [
...
,  
  ...
  },
  {
    ...
    "category": "文系",
    "content": {
      "question": "\\(a,b\\)を正の実数とする。直線\\(L: ax + by = 1\\)と曲線\\(y = -\\frac{1}{x}\\)との2つの交点のうち、\\(y\\)座標が正のものを\\(P\\)、負のものを\\(Q\\)とする。また、\\(L\\)と\\(x\\)軸との交点を\\(R\\)とし、\\(L\\)と\\(y\\)軸との交点を\\(S\\)とする。\\(a, b\\)が条件\n\\[ \\frac{PQ}{RS} = \\sqrt{2} \\]\nを満たしながら動くとき、線分\\(PQ\\)の中点の軌跡を求めよ。",
      "hints": [
